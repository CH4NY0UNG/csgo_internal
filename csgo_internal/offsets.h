...
namespace offsets
{
	...
	constexpr ptrdiff_t dwEntityList = 0x4DFCE74;
	constexpr ptrdiff_t dwForceAttack = 0x322AC7C;
	constexpr ptrdiff_t dwForceAttack2 = 0x322AC88;
	constexpr ptrdiff_t dwForceBackward = 0x322ACB8;
	constexpr ptrdiff_t dwForceForward = 0x322ACAC;
	constexpr ptrdiff_t dwForceJump = 0x52B8BFC;
	constexpr ptrdiff_t dwForceLeft = 0x322ACC4;
	constexpr ptrdiff_t dwForceRight = 0x322ACD0;
	constexpr ptrdiff_t dwGameDir = 0x63AD80;
	constexpr ptrdiff_t dwGameRulesProxy = 0x532C42C;
	constexpr ptrdiff_t dwGetAllClasses = 0xE08FDC;
	constexpr ptrdiff_t dwGlobalVars = 0x59EE58;
	constexpr ptrdiff_t dwGlowObjectManager = 0x5357948;
	constexpr ptrdiff_t dwInput = 0x525A448;
	constexpr ptrdiff_t dwInterfaceLinkList = 0x999E44;
	constexpr ptrdiff_t dwLocalPlayer = 0xDE7964;
	constexpr ptrdiff_t dwMouseEnable = 0x52360A8;
	constexpr ptrdiff_t dwMouseEnablePtr = 0x5236078;
	constexpr ptrdiff_t dwPlayerResource = 0x3229020;
	constexpr ptrdiff_t dwRadarBase = 0x523394C;
	constexpr ptrdiff_t dwSensitivity = 0xCEE5002E;
	constexpr ptrdiff_t dwSensitivityPtr = 0xCEE50002;
	constexpr ptrdiff_t dwSetClanTag = 0x8DA80;
	constexpr ptrdiff_t dwViewMatrix = 0x4DEDCA4;
	constexpr ptrdiff_t dwWeaponTable = 0x525B524;
	constexpr ptrdiff_t dwWeaponTableIndex = 0x326C;
	constexpr ptrdiff_t dwYawPtr = 0xCEE50002;
	constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xCEE50002;
	constexpr ptrdiff_t dwbSendPackets = 0xDCF92;
	constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA62C0;
	constexpr ptrdiff_t m_pStudioHdr = 0x2950;
	constexpr ptrdiff_t m_yawClassPtr = 0xCEE50002;
	constexpr ptrdiff_t m_pitchClassPtr = 0x5235FA0;
	...
	constexpr ptrdiff_t set_abs_angles = 0x1E5C50;
	constexpr ptrdiff_t set_abs_origin = 0x1E5A90;
	constexpr ptrdiff_t is_c4_owner = 0x3E5500;
	constexpr ptrdiff_t force_update_spectator_glow = 0x3D7CFA;
	constexpr ptrdiff_t anim_overlays = 0x2990;
	constexpr ptrdiff_t m_flSpawnTime = 0x103C0;
	constexpr ptrdiff_t find_hud_element = 0x3147E560;
